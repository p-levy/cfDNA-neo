...
ascat.prepareHTS(
    ...
    tumourname = paste0(tumor_sample_name, "_cfDNA"),
...
ascat.bc <- ascat.loadData(Tumor_LogR_file = paste0(tumor_sample_name, "_cfDNA_tumourLogR.txt"), Tumor_BAF_file = paste0(tumor_sample_name, "_cfDNA_tumourBAF.txt"), Germline_LogR_file = paste0(tumor_sample_name, "_cfDNA_normalLogR.txt"), Germline_BAF_file = paste0(tumor_sample_name, "_cfDNA_normalBAF.txt"), gender = sex, genomeVersion = genome)
